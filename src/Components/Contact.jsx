  ...
  return (
    <div id="contact" className="bg-teal-900 text-[#DDFFE7]">
      ...
      <p className="text-center text-sm px-2 opacity-80 font-extralight sm:text-lg text-[#DDFFE7]">
        Have a question or want to work together? Send me a message or Email me at <a href="mailto:atif.ansari981@gmail.com" className="underline text-zinc-900 font-medium">atif.ansari981@gmail.com</a>, I'll reach out to you as soon as I can.
      </p>
      ...
      <div className="flex flex-col md:flex-row justify-around items-center">
        <div className="flex flex-row space-x-4">
          <div className="flex flex-row justify-center items-center">
            ...
            <a href="mailto:atif.ansari981@gmail.com" className="text-sm md:text-base underline font-extralight opacity-80 text-[#DDFFE7] border-r px-2">
              atif.ansari981@gmail.com
            </a>
          </div>
          <div className="flex justify-center my-8 space-x-4">
            <a href="https://github.com/atif2786">
              <img
                src={githubLogo}
                alt=""
            ...
            <a href="https://www.linkedin.com/in/mohd-atif-ansari/">
              <img
                src={inLogo}
                alt=""
                className="w-8 cursor-pointer hover:scale-105 hover:-translate-y-1.5 transition-all duration-500"
        ...
        <div className="text-center">
          <a href="tel:+917879433661" className="text-sm md:text-base underline underline-offset-2 font-thin tracking-wide text-[#DDFFE7]">Call : +91 7879433661</a>
        </div>
      </div>
    </div>
  );
