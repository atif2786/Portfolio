  ...
  return (
    <div id="about" className="bg-teal-900 text-[#DDFFE7]">
      ...
      <p className="text-[#DDFFE7] text-sm tracking-wide px-4 xs:px-4 md:px-2 mt-4 mb-8 opacity-80 md:text-left md:text-xl md:w-1/2">
        This is me,{" "}
        <span className="font-medium text-zinc-900"> MOHAMMAD ATIF ANSARI</span>, a
        Full Stack Web Developer. The scope of my work mostly includes quality web design by integrating powerful designing tools such as Tailwind CSS with frontend tools---Reactjs,HTML,Python , backend tools---Nodejs, Expressjs and non-relational database---MongoDB,relational database---Sql.
        <br />
        <br />
