...
function Home() {
  ...
  return (
    <div className="bg-teal-900">
      {/* Navbar */}
      <nav className="flex justify-between items-center py-4 sticky top-0 shadow-xl bg-[#0e7490] z-10">
        <p
          className="text-[#e5e5e5] ml-4 text-xl cursor-pointer"
      ...
      >
        <a
          href="mailto:atif.ansari981@gmail.com"
        ...
        <div className="px-4 flex flex-col space-y-3">
          <div className="space-y-2 border-l-8 pl-5">
            ...
            <p className="text-left text-[#DDFFE7] font-thin tracking-wide text-xs sm:text-sm sm:w-3/4 lg:w-[70%]">
              Goal-oriented Web Developer with a Bachelor's of Engineering and looking to enhance my professional experience
